"""Continuous-action simulation loop."""
...
class ContinuousSimulator:
    """Minimal simulator for continuous action policies."""

    def __init__(self, policy: CATSLikePolicy, world: ContinuousWorld, seed: int = 0) -> None:
        self.policy = policy
        self.world = world
        self.seed = seed
        self.current_step = 0
    ...
    def step(self) -> ContinuousStepResult:
        ...
        result = ContinuousStepResult(
            ...
            metadata={"debug": self.policy.get_debug_snapshot()},
        )
